...
public class BaseDatos extends javax.swing.JFrame {
    ...
    private void btnModificaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificaActionPerformed
        ...
        forum = new Formulario2(this, true, nombre, Integer.parseInt(edad)); //Inicializacion JDialog
    ...
    /*Base de Datos*/
        protected void RellenarTablaPersona(String nombre, int edad) {    
            String persona[] = {nombre, Integer.toString(edad)}; //Almacen de variables
            modeloTablaPersona.addRow(persona); //Implementacion de variables

            TableDatosPersona.setModel(modeloTablaPersona); //Actualizar Base de Datos
        }

        protected void ModificarTablaPersona(String nombre, int edad) {     

            modeloTablaPersona.setValueAt(nombre, TableDatosPersona.getSelectedRow(), 0); //Implementacion de variables, primer columna (Base de Datos)
            modeloTablaPersona.setValueAt(edad, TableDatosPersona.getSelectedRow(), 1); //Implementacion de variables, segunda columna (Base de Datos)
