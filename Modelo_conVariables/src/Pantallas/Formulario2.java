...
public class Formulario2 extends javax.swing.JDialog {
    ...
    public Formulario2(java.awt.Frame parent, boolean modal, String nombre, int edad) {
        super(parent, modal);
        ...
        txtNombrePersona.setText(nombre); //Campo texto dibujado
        txtEdadPersona.setText(Integer.toString(edad)); //Campo texto dibujado
    }
    ...
    private void btnInicioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInicioActionPerformed
        try {
            ...
            data.ModificarTablaPersona(nombre, edad); //Metodo Principal
